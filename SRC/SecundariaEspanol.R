...
colnames(Pri3Esp2011) <- c("cct", "cal_esp1", "N1")
colnames(Pri4Esp2011) <- c("cct", "cal_esp2", "N2")
colnames(Pri5Esp2011) <- c("cct", "cal_esp3", "N3")
...
write.csv(SecundariaEspanol, "Out-Data/SecundariaEsp2011.csv")